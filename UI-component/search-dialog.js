      ...
      + '<div class="notepad-dlg-search">'
        + '<div class="dialogbox notepad-dlgbox">'
          ...
          + '<div class="main notepad-dlg-main">'
            ...
            + '<label><input class="check" type="checkbox" value="capital-sense">区分大小写(C)</label>'
            + '<fieldset class="search-direction">'
              + '<legend>方向</legend>'
              + '<label><input class="up" type="radio" name="direction" value="up">向上(U)</label>'
              + '<label><input class="down"  type="radio" name="direction" value="down" checked>向下(D)</label>'
            + '</fieldset>'
